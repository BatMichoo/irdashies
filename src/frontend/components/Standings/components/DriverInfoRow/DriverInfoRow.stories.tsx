...
const AllFlagCombinations = () => {
  const flagCombinations = [
    ...
    {
      name: 'Pit Lap with Time (L 5 1:24)',
      dnf: false,
      repair: false,
      penalty: false,
      slowdown: false,
    ...
    {
      name: 'Pit Lap with Time (L 5 0:34)',
      dnf: false,
      repair: false,
      penalty: false,
      slowdown: false,
